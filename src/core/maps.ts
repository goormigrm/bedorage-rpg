...
export const MAPS: Record<MapId, MapDef> = {
  ...
  town1: {
    ...
    theme: {
      floor: 0x6a5d4a, floorAlt: 0x625644, floorLine: 0x4a4234,
      wall: 0x4a3a2a, wallTop: 0x6a5238, crate: 0x6e5236, outside: 0x040403,
      sunColor: 0x8aa0c8, ambientColor: 0x8a8498, fog: 0x050505,
      // 마을은 안전지대라 훤하게 (2026-09-19 — 시야 밖 어둠 0.8 이면 등불 둘레만 보여 마을이 비어 보였다)
      dark: { sun: 1.35, hemi: 1.3, fogAlpha: 0.4, lantern: 2.8 },
      style: 'town',
    },
  },
  fields: {
  ...
  town2: {
    ...
    theme: {
      ...
      sunColor: 0x8ab0b0, ambientColor: 0x7e9488, fog: 0x030504,
      dark: { sun: 1.3, hemi: 1.25, fogAlpha: 0.4, lantern: 2.8 },
      style: 'town',
    },
  },
  forest: {
  ...
  town3: {
    ...
    theme: {
      ...
      sunColor: 0xc8b088, ambientColor: 0xa09078, fog: 0x050403,
      dark: { sun: 1.3, hemi: 1.3, fogAlpha: 0.4, lantern: 2.8 },
      style: 'town',
    },
  },
  sewer: {
  ...
  town4: {
    ...
    theme: {
      ...
      sunColor: 0xd0806a, ambientColor: 0xa07870, fog: 0x060303,
      dark: { sun: 1.3, hemi: 1.3, fogAlpha: 0.4, lantern: 2.7 },
      style: 'town',
    },
  },
  rift: {
