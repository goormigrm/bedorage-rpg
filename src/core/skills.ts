...
const BASE_SKILLS: Record<BaseSkillId, SkillDef> = {
  ...
  // 2026-09-19 철면덕이 고기 바이올린(근접)을 든 뒤로 "탄막" → 격정 연주
  ...
  // 2026-09-19 주펄덕 = 힐러: 반사광 → 후광(동료 치유 · 피해 감소), 초신성에 치유를 더한다
  ...
  // 2026-09-19 기열덕 = 탱커: 고함에 도발을 붙인다
  shout: { id: 'shout', name: '고함', desc: '앞 5칸 부채꼴에 50 피해 · 멀리 밀치고 2초 느리게. 던전에서는 8칸 안 괴물이 5초간 나만 노리고, 나는 5초간 받는 피해 -30%.', cd: s(10) },
